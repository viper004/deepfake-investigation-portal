...
class AIAnalysis(Base):
    ...
    tampered_probability = Column(Float, nullable=True)
    authentic_probability = Column(Float, nullable=True)
    classification_threshold = Column(Float, nullable=True, default=0.40)
    localization_available = Column(Boolean, nullable=True, default=False)
    localization_threshold = Column(Float, nullable=True, default=0.35)
...
class AuditLog(Base):
    ...
    module = Column(String(50), nullable=False, default="System")
